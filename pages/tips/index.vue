...
<template>
  <div>
    <div class="mb-4" style="position: relative;">
			...
			<div style="inset: 0;" class="d-flex align-center justify-center position-absolute">
				<div class="text-center px-4">
					<p class="mb-1 hero-title text-white">Tips & Advice</p>
					<p class="mb-0 hero-subtitle text-white">Discover helpful tips and tricks for your painting projects</p>
				</div>
			</div>
		</div>
    ...
    <VCard v-else-if="articles.length === 0" class="text-center py-12">
      <VIcon icon="tabler-bulb" size="64" class="text-disabled mb-4" />
      <h3 class="text-h6 text-disabled mb-2">No tips available yet</h3>
      <p class="text-body-2 text-disabled">Check back soon for helpful tips!</p>
    </VCard>
